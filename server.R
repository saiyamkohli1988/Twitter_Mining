...
shinyServer(function(input, output) {
  ...
  pos.words = scan('C:/Users/Saiyam Kohli/Desktop/Data Mining Stuffs/positivewords.txt', what='character', comment.char=';')
  neg.words = scan('C:/Users/Saiyam Kohli/Desktop/Data Mining Stuffs/negativewords.txt', what='character', comment.char=';')
  ...
  extract.hashes = function(vec){
    ...
    hash.matches = gregexpr(pattern = hash.pattern,
                            text = vec[have.hash])
    extracted.hash = regmratches(x = vec[have.hash], m = hash.matches)
